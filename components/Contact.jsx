...
import contactImg from "../public/assets/Julian-photo.webp";
...
const Contact = () => {
  return (
    <div id="contact" className=" w-full lg:h-screen ">
      <div className=" max-w-7xl m-auto px-2 pt-16 pb-40 md:pt-28 w-full">
        ...
        <div className=" grid lg:grid-cols-5 gap-8">
          {/*  */}
          {/* LEFT COLUMN */}
          <div className=" col-span-3 lg:col-span-2 w-full h-full shadow-md shadow-gray-400 rounded-xl p-4 bg-gray-50">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                ...
                <p className=" py-4">
                  Whether you're launching a new brand, refreshing your digital
                  presence, or exploring creative strategy, I’d love to hear
                  from you. Drop me a note and let’s start the conversation.
                </p>
              </div>
              <div>
                ...
                <div className=" flex items-center justify-center gap-4 max-w-sm m-auto py-4">
                  <a
                    ...
                    target="_blank"
                  >
                    <div className=" rounded-2xl shadow-sm shadow-gray-400 p-3 cursor-pointer hover:scale-125 ease-in duration-300 bg-white hover:text-[#c2649a]">
          ...
          <div className=" col-span-3 w-full h-auto shadow-md shadow-gray-400 rounded-xl lg:p-4 bg-gray-50">
            <div className=" p-4">
